...
class ImprovedPaystationHostedPayment extends Payment
{
    ...
    public static function set_paystation_id($paystation_id)
    {
        self::$paystation_id = $paystation_id;
    }

    public static function set_gateway_id($gateway_id)
    {
    ...
    public static function get_paystation_id()
    {
    ...
    public function RedirectJavascript($url)
    {
